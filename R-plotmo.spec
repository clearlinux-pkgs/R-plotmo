...
Version  : 3.6.4
Release  : 65
URL      : https://cran.r-project.org/src/contrib/plotmo_3.6.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/plotmo_3.6.4.tar.gz
...
%setup -q -n plotmo
pushd ..
cp -a plotmo buildavx2
popd
pushd ..
cp -a plotmo buildavx512
popd
pushd ..
cp -a plotmo buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725101473
...
/usr/lib64/R/library/plotmo/NEWS.md
